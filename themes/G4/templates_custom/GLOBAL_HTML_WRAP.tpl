...
{+START,IF,{$NOT,{$MOBILE}}}
<div id="topNavContainer" class="navContainer">
            <div id="topNav" class="clearfix">
            <ul><li></li></ul>
            <ul class="aux">
            <li class="rss22"><a href="http://feeds.feedburner.com/G4manicNews" target="_blank"><span>RSS</span></li></a>
            <li class="twitter22"><a href="https://twitter.com/G4Manic_" target="_blank"><span>TWITTER</span></li></a>
            <li class="newsletter22"><a href="https://www.g4manic.com/site/newsletter.htm"><span>NEWSLETTER</span></li></a>                
</ul></div></div>
{+END}
...
{$,The main logo}
<h1 class="logo_outer"><a target="_self" href="{$PAGE_LINK*,:}" rel="home"><img class="logo" src="{$?*,{$MOBILE},{$IMG,logo/standalone_logo},{$LOGO_URL}}"{+START,IF,{$NOT,{$MOBILE}}} width="{$IMG_WIDTH*,{$LOGO_URL},1}" height="{$IMG_HEIGHT*,{$LOGO_URL},1}"{+END} alt="{$SITE_NAME*}" /></a></h1>
{$,Main menu}
...
<a href="{$MEMBER_PROFILE_URL}#tab__points"><img class="top_points" src="{$IMG,points}" title="{!POINTS} : {$AVAILABLE_POINTS}" alt="{!POINTS}" /></a>
...
$(document).ready(function() {
			// grab the initial top offset of the navigation 
		   	var stickyNavTop = $('.global_navigation').offset().top;
		   	...
		   	var stickyNav = function(){
			    ...
			    if (scrollTop > stickyNavTop) { 
			        $('.global_navigation').addClass('sticky_nav');
			    } else {
			        $('.global_navigation').removeClass('sticky_nav'); 
			    }
			};
