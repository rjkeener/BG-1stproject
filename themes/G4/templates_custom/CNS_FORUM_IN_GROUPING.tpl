<tr>
	{+START,IF,{$NOT,{$MOBILE}}}
     {+START,IF_EMPTY,{$CATALOGUE_ENTRY_FOR,forum,{ID},0}}     
    <td class="cns_forum_new_post_indicator cns_column1 cns_no_new">
    <img width="32" height="32" title="{LANG_NEW_POST_OR_NOT*}" alt="{LANG_NEW_POST_OR_NOT*}" src="{$IMG*,cns_general/{NEW_POST_OR_NOT*}}" />
    </td>
    {+END}    
    {+START,IF_NON_EMPTY,{$CATALOGUE_ENTRY_FOR,forum,{ID},0}}
    {+START,IF,{$EQ,{LANG_NEW_POST_OR_NOT*},No new posts}}
    <td class="cns_forum_new_post_indicator cns_column1 cns_no_new">
    <img width="32" height="32" title="{LANG_NEW_POST_OR_NOT*}" alt="{LANG_NEW_POST_OR_NOT*}" src="{$BASE_URL}/{$CATALOGUE_ENTRY_FIELD_VALUE_PLAIN,{$CATALOGUE_ENTRY_FOR,forum,{ID}},0}" />
    </td>
    {+END}
    {+START,IF,{$EQ,{LANG_NEW_POST_OR_NOT*},New posts}}
