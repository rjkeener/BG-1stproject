...
<section class="box box___block_main_image_fader_news"><div class="box_inner">
	...
	<div class="image_fader_news_container">
				...
				{+START,IF,{$NEQ,{NEWS},1}}
					<div class="pagination">
						...
						<nav class="float_surrounder">
							<a onclick="return window.main_image_fader_news_cycle_{$GET,RAND_FADER_NEWS}(-1);" rel="prev" accesskey="j" href="#" class="light"></a><a id="pause_button_{$GET,RAND_FADER_NEWS}" onclick="return window.main_image_fader_news_pause_{$GET,RAND_FADER_NEWS}();" href="#" class="light"></a><a onclick="return window.main_image_fader_news_cycle_{$GET,RAND_FADER_NEWS}( 1);" rel="next" accesskey="k" href="#" class="light"></a>
						</nav>
					</div>
				{+END}
			{+END}
