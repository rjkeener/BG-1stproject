			...
			<div class="download_stats_wrapper">
				<div class="wide_table_wrap"><table class="map_table download_stats results_table wide_table" role="note">
					...
					<tbody>
						...
						{+END}
						{+START,IF_NON_EMPTY,{$CATALOGUE_ENTRY_FIELD_VALUE,{$CATALOGUE_ENTRY_FOR,download,{ID}},1}}
						<tr>
							<th class="de_th metadata_title">Compatible</th>
							<td>
								{$CATALOGUE_ENTRY_FIELD_VALUE,{$CATALOGUE_ENTRY_FOR,download,{ID}},1}
							</td>
						</tr>
						{+END}
						...
						{+START,IF,{$INLINE_STATS}}
							<tr>
								<th class="de_th metadata_title">{!COUNT_VIEWS}{FIELD_66*}</th>
								<td>{VIEWS*}</td>
							</tr>
						{+END}
						...
						{+START,IF_NON_EMPTY,{$CATALOGUE_ENTRY_FIELD_VALUE,{$CATALOGUE_ENTRY_FOR,download,{ID}},2}}
						<tr>
							<th class="de_th metadata_title">Support</th>
							<td>
								{$CATALOGUE_ENTRY_FIELD_VALUE,{$CATALOGUE_ENTRY_FOR,download,{ID}},2}
							</td>
						</tr>
                                                {+END}
