...
{pic.src=((pic.src.indexOf('themewizard.php')!=-1)?pic.src.replace('expand','contract'):'https://csm.wearebeatgrid.com/themes/BeatGrid_CSM/images/1x/trays/contract.png').replace(/^https?:/,window.location.protocol);if(typeof pic.srcset!='undefined')
...
{pic.src=((pic.src.indexOf('themewizard.php')!=-1)?pic.src.replace('contract','expand'):'https://csm.wearebeatgrid.com/themes/BeatGrid_CSM/images/1x/trays/expand.png').replace(/^https?:/,window.location.protocol);if(typeof pic.srcset!='undefined')
pic.srcset=((pic.src.indexOf('themewizard.php')!=-1)?pic.srcset.replace('contract','expand'):'https://csm.wearebeatgrid.com/themes/BeatGrid_CSM/images/2x/trays/expand.png 2x').replace(/^https?:/,window.location.protocol);pic.setAttribute('alt','Expand');pic.setAttribute('title','Expand');new_state='none';new_state_2='none';new_state_3='0';}
