<?php /*
 ...
 BeatGrid
 Copyright (c) ocProducts/BeatGrid Music Artist Services, 2004-2016
 ...
 * @copyright  ocProducts/BeatGrid Music Artist Services Ltd
 * @package    core
 */
...
if (!function_exists('critical_error')) {
    ...
    function critical_error($code, $relay = null, $exit = true)
    {
        ...
        $error = 'Unknown critical error type: this should not happen, so please report this to ocProducts/BeatGrid Music Artist Services.';
        ...
        switch ($code) {
            ...
            case '_CONFIG.PHP_CORRUPTED':
                ...
                break;
            case 'CRIT_LANG':
                $error = 'The most basic critical error language file (lang/' . fallback_lang() . '/critical_error.ini) is missing. It is likely that other files are also, for whatever reason, missing from this BeatGrid installation.';
                break;
        }
...
END;
        ...
        echo $extra, "\n";
        if ($may_show_footer) {
            echo '<p>Details here are intended only for the website/system-administrator, not for regular website users.<br />&raquo; <strong>If you are a regular website user, please let the website staff deal with this problem.</strong></p>' . "\n" . '<p class="associated_details">Depending on the error, and only if the website installation finished, you may need to <a href="#" onclick="if (!window.confirm(\'Are you staff on this site?\')) return false; this.href=\'' . htmlentities($edit_url) . '\';">edit the installation options</a> (the <kbd>_config.php</kbd> file).</p>' . "\n" . '<p class="associated_details">ocProducts/BeatGrid Music Artist Services maintains full documentation for all procedures and tools (including <a href="https://www.wearebeatgrid.com/docs/tut-disaster.htm">disaster recovery</a>). These may be found on the <a href="https://www.wearebeatgrid.com">BeatGrid website</a>. If you are unable to easily solve this problem, we may be contacted from our website and can help resolve it for you.</p>' . "\n" . '<hr />' . "\n" . '<p style="font-size: 0.8em"><a href="https://www.wearebeatgrid.com/">BeatGrid</a> is a <abbr title="Content Management System">CMS</abbr> for building websites, developed by ocProducts/BeatGrid Music Artist Services.</p>' . "\n";
        }
        echo '</div></body>' . "\n" . '</html>';
